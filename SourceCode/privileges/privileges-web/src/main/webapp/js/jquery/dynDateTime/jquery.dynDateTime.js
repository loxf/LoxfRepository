	...
	$.fn.dynDateTime = function(options) {
		...
		return this.each(function() {
			...
			if (this_flat != null) {
				...
				var cal = new Calendar(opts.firstDay, opts.date, opts.onSelect || onSelect,onClear);
...
Calendar = function (firstDayOfWeek, dateStr, onSelected,onClear, onClose) {
	// member variables
	this.activeDiv = null;
...
Calendar.prototype.create = function (_par) {
	...
	this._nav_clear = hh(Calendar._TT["TOCLEAR"], this.weekNumbers ? 2 : 1, 1000);
	this._nav_clear.ttip = Calendar._TT["GO_TOCLEAR"];
